---
title: "Persistent Individual Differences and Age Shape Post-Breeding Molt Dynamics in a Partially Migratory Shorebird"
...
```{r}
#| code-fold: true
#| code-summary: "Show code for figure 3"
#| fig-width: 7
#| fig-height: 10
#| fig-dpi: 300
#| out-width: "7in"
...
```{r}
#| code-fold: true
#| code-summary: "Show code for breeding phenology sensitivity datasets"
...
```{r, eval=FALSE}
#| code-fold: true
#| code-summary: "Show code for breeding phenology sensitivity model fitting"
...
```{r}
#| code-fold: true
#| code-summary: "Show code for the continuous age sensitivity dataset"
...
```{r, eval=FALSE}
#| code-fold: true
#| code-summary: "Show code for continuous age sensitivity model fitting"
...
```{r, echo=FALSE, eval=FALSE}
saveRDS(list(fitted_model = fit_mod_sex_age2_avg, 
             data = dat_age2_mod),
        file = here("out/sex_age2_avg_mod.rds"))
```

### Do migratory strategies differ in breeding phenology?
```{r}
#| code-fold: true
#| code-summary: "Show code for data wrangle steps for analysis of migratory strategy and breeding phenology"
# wrangle data
...
```{r}
#| code-fold: true
#| code-summary: "Show code for data wrangle steps for analysis of age and breeding phenology"
...
```{r}
#| code-fold: true
#| code-summary: "Show code for data wrangle steps for analysis of sex and breeding phenology"
