...
# summarize the number of individuals in the dataset...87 unique combos
dat %>%
  pull(Rings_comb) %>% unique() %>% length()

# summarise the number of seasons for each individual...54 have more than one season of data
dat %>%
